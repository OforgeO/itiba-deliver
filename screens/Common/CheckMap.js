...
class CheckMap extends React.Component {
    ...
    openNavi() {
        if(this.state.startPoint && this.state.endPoint) {
            OpenMapDirections(this.state.startPoint, this.state.endPoint, this.state.transportPlan).then(res => {
            });
        }
    }
            ...
            <Container style={[shared.mainContainer]}>
                ...
                <SafeAreaView style={{ flex: 1, backgroundColor: 'white'}}>
                    ...
                    <View>
                        ...
                        <View style={{width: '100%', paddingHorizontal: normalize(20), bottom : 100}}>
                        ...
                        <View style={{width: '100%', paddingHorizontal: normalize(20), bottom : 40}}>
                            <TouchableOpacity onPress={() => this.openNavi()} style={styles.closeBtn}>
                                <BoldText style={[fonts.size16, {color: 'white'}]}>ナビを開く</BoldText>
                            </TouchableOpacity>
                        </View>
                    </View>
